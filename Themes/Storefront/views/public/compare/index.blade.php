...
@push('globals')
    <script>
        FleetCart.langs['storefront::compare.add_to_cart'] = '{{ trans('storefront::compare.add_to_cart') }}';
        FleetCart.langs['storefront::compare.view_options'] = '{{ trans('storefront::compare.view_options') }}';
    </script>
@endpush
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td v-for="product in products">
                                        ...
                                        <button
                                            :title="$trans(hasAnyOption(product) ? 'storefront::compare.view_options' : 'storefront::compare.add_to_cart')"
                                            class="btn btn-add-to-cart"
                                            :disabled="!productIsInStock(product)"
                                            @click="addToCart(product)"
                                        >
                                            <i class="las" :class="hasAnyOption(product) ? 'la-eye' : 'la-shopping-cart'"></i>
                                        </button>
                                    </td>
                                </tr>
                            </tbody>
